                ...
                <div class="pad-btm form-inline">
                    <div class="row">
                        <div class="col-sm-6 table-toolbar-right" style="float:right">
                                <a href="<?php echo Yii::$app->urlManager->createUrl(['/system/form-category/add']);?>" class="btn btn-success">
                            ...
                            <?php foreach($data as $k=>$v): ?>
                                <tr id="tr_<?= $v['id'];?>">
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo Yii::$app->urlManager->createUrl(['/system/form-category/add','id'=>$v['id']]);?>" class="btn btn-sm btn-info">编辑</a>
            ...
            bootbox.confirm('确认删除？删除后数据不能恢复！', function(ok) {
                if(ok) {
                    $.ajax({
                        type:"POST",
                        cache:false,
                        url:'<?php echo Yii::$app->urlManager->createUrl(['/system/form-category/delete']);?>',
                        data:{
                            id:id
                        },
                        dataType:'json',
