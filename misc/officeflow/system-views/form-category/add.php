    ...
    var obj = {
        ...
        save:function(){
            ...
            $.ajax({
                type:"POST",
                cache:false,
                url:'<?php echo Yii::$app->urlManager->createUrl(['/system/form-category/save']);?>',
                ...
                success:function(resp) {
                    if(resp.e == 0) {
                        alert(resp.m);
                        setTimeout(function(){
                            window.location.href="<?php echo Yii::$app->urlManager->createUrl(['/system/form-category/index']);?>";
                        },1500);
                    } else {
                        alert(resp.m);
                    }
